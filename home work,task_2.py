# Aceasta este a doua sarcină legată de booleni în python 
...
# Acum utilizați operatorul 'and' pentru a verifica atât 'is_student' , cât și 'is_child' sunt 'True' și tipăriți rezultatul folosind funcția 'print'

# CODUL TĂU VINE MI JOS:
# Truth Table for AND Operator
is_student and is_child = True
